        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card shadow-sm border-bottom-primary">
                    ...
                    <div class="card-body">
                        <form action="<?= base_url() ?>relasi/proses_add" method="post">

                            <div class="row form-group">
                                <label class="col-md-3 text-md-right" for="Bobot">Bobot</label>
                                <div class="col-md-9">
                                    <input value="" name="bobot" id="bobot" type="text" class="form-control" placeholder="Bobot...">
                                    <!-- <input type="hidden" name="id_relasi" value="0" /> -->
                                </div>
                            </div>
                            <div class="row form-group">
                                    ...
                                    <div class="input-group">
                                        <select name="kd_gejala" id="kd_gejala" class="custom-select">
                                            ...
                                            <?php foreach ($gejala as $g) : ?>
                                                <option <?= set_select('kd_gejala', $g['kd_gejala']) ?> value="<?= $g['kd_gejala'] ?>"><?= $g['kd_gejala'] . ' | ' . $g['gejala'] ?></option>
                                            <?php endforeach; ?>
                                        </select>
                                    ...
                                    <div class="input-group">
                                        <select name="kd_penyakit" id="kd_penyakit" class="custom-select">
                                            ...
                                            <?php foreach ($penyakit as $p) : ?>
                                                <option <?= set_select('kd_penyakit', $p['kd_penyakit']) ?> value="<?= $p['kd_penyakit'] ?>"><?= $p['kd_penyakit'] . ' | ' . $p['nama_penyakit'] ?></option>
                                            <?php endforeach; ?>
                                        </select>
                                        <div class="input-group-append">
